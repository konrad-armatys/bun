...
impl PostgresSQLConnection {
    ...
    pub fn finalize(self: Box<Self>) {
        ...
        // Refcounted: releases the JS wrapper's +1 after the work below; the
        // allocation may outlive this call if other refs remain.
        bun_ptr::finalize_js_box(self, |this| {
            ...
            // the release below can free the connection.
