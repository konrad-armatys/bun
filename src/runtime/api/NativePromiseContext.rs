    ...
    pub(crate) fn run_from_js_thread(packed_ptr: usize) {
        ...
        unsafe {
            match tag {
                ...
                Tag::HTTPSServerH3RequestContext => {
                    drop(destroyed_ref::<HTTPSServerH3RequestContext>(ctx))
                }
                Tag::DebugHTTPSServerH3RequestContext => {
                    drop(destroyed_ref::<DebugHTTPSServerH3RequestContext>(ctx))
                }
...
const _: () =
    assert!(core::mem::align_of::<HTTPSServerH3RequestContext>() > DeferredDerefTask::TAG_MASK);
const _: () = assert!(
    core::mem::align_of::<DebugHTTPSServerH3RequestContext>() > DeferredDerefTask::TAG_MASK
);
const _: () =
